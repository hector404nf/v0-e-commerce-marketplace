      ...
      <div className="w-full max-w-md">
        <Card className="shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-1 text-center pb-8">
            ...
            <CardDescription className="text-gray-600">Únete a la comunidad de MiMarket</CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start space-x-2">
                ...
                <Label htmlFor="acceptTerms" className="text-sm text-gray-600 leading-relaxed">
                  Acepto los{" "}
                  <Link href="/terminos" className="text-green-600 hover:text-green-800 underline">
                    términos y condiciones
                  </Link>{" "}
                  y la{" "}
                  <Link href="/privacidad" className="text-green-600 hover:text-green-800 underline">
